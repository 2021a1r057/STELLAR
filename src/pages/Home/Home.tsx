    ...
    <div className="home">
      <section className="home__first-section">
        <div className="home__info">
          <h1 className="home__logo">STELLAR☾</h1>
          <h2 className="home__heading">Astrology in your pocket.</h2>
          <p className="home__subheading">
            Welcome to the mystical world of STELLAR, your gateway to unlocking
      ...
      <section className="home__second-section">
        <h2 className="home__heading">What can you find on STELLAR?</h2>
